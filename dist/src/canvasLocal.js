export class CanvasLocal {
  ...
  paint() {
      ...
      for(let i=1.3; i<=4;){
        ...
        this.drawface(
          this.iX(0.53+a), //x es para la izquierda punto uno
            this.iY(5.33-c), //es la altura del moviento arriba hacia abajo
            this.iX(0.8+a), //esquina similar a 0.5
            this.iY(5-c),//continuidad de 5.4
            this.iX(1.3+a), //
            this.iY(4.8-c), //
            this.iX(1.8+a), //
            this.iY(5-c),//
